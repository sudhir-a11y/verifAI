...
FALLBACK_RULES: list[dict[str, Any]] = [
    ...
    {
        "rule_id": "R011",
        "name": "Fracture case missing X-ray evidence and X-ray billing support",
        "scope": ["fracture", "radiology", "query"],
        "decision": "QUERY",
        "severity": "SOFT_QUERY",
        "priority": 9,
        "required_evidence": ["X-ray/radiology report", "X-ray/radiology bill line items"],
    },
    {
        "rule_id": "R007",
