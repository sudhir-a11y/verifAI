...
TARGET_USERNAMES = ("drsapna", "draanchal")
...
def main() -> int:
    ...
    out: dict[str, object] = {"targets": list(TARGET_USERNAMES)}
    ...
    with psycopg.connect(host=host, port=port, user=user, password=password, dbname=dbname) as conn:
        with conn.cursor() as cur:
            ...
            backup_path = backup_dir / f"{dbname}_before_delete_users_drsapna_draanchal_{ts}.dump"
